package com.zcw.baseutildemo.https;
...
//        test.pin();
    ...
    private void customTrust() throws Exception {
        X509TrustManager x509TrustManager;
        SSLSocketFactory sslSocketFactory;
        try {
            x509TrustManager = trustManagerForCertificates(trustedCertificatesInputStream());
